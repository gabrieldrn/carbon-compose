...
//
//
//private enum class OldComponent {
//    AI,
//    TAG,
//    CHAT,
//    NOTIFICATION,
...
//}
//
//fun oldGenerateThemeImplementations(themesTokens: Map<String, MutableList<TokenProperty>>) {
//
//    //  Theme ------v
//    val tokens: Map<String, Map<OldComponent, MutableList<TokenProperty>>> =
//        themesTokens.mapValues { (_, tokens) ->
//            val map: Map<OldComponent, MutableList<TokenProperty>> =
//                OldComponent.entries.associateWith { mutableListOf() }
//
//            tokens.forEach { token ->
//                val component = when {
//                    token.name.startsWith("tag") -> OldComponent.TAG
//                    token.name.startsWith("ai") -> OldComponent.AI
//                    token.name.startsWith("chat") -> OldComponent.CHAT
//                    token.name.startsWith("notification") -> OldComponent.NOTIFICATION
//                    else -> OldComponent.CORE
//                }
//
...
//    val componentAbstractions = mutableMapOf<OldComponent, ClassName>()
//
//    tokens.values
//        .distinctBy { it.keys }
//        .forEach { componentsWithTokens ->
//            componentsWithTokens
//                .filterNot { it.key == OldComponent.CORE }
//                .mapValues {
...
//    val componentsImplementations = mutableMapOf<String, MutableMap<OldComponent, ClassName>>()
//
...
//        tokenProperties = tokens.values.first()[OldComponent.CORE]!!,
...
//            theme = theme,
//            tokenProperties = componentTokens[OldComponent.CORE]!!,
//            componentsAbstractions = componentAbstractions,
...
//    componentsAbstractions: Map<OldComponent, ClassName>
//) {
...
//    tokenProperties: List<TokenProperty>,
//    componentsAbstractions: Map<OldComponent, ClassName>,
//    componentsImplementations: Map<OldComponent, ClassName>
//) {
