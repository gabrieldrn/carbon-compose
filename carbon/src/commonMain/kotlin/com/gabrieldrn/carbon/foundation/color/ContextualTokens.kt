...
public fun Theme.layerBackgroundColor(layer: Layer = Layer.Layer00): Color = when (layer) {
    Layer.Layer00 -> layerBackground01
    Layer.Layer01 -> layerBackground02
    else -> layerBackground03
}
 ...
 * @param layer Containing layer. Defaults to layer 00.
 */
public fun Theme.fieldColor(layer: Layer = Layer.Layer00): Color = when (layer) {
