...
internal object TextInputTestTags {
    const val LABEL = "carbon_textinput_label"
    const val COUNTER = "carbon_textinput_counter"
    const val PLACEHOLDER = "carbon_textinput_placeholder"
    const val FIELD = "carbon_textinput_field"
